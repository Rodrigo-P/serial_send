...
ser=serial.Serial(porta,timeout=1)
print(ser.portstr)
ser.write(str(pos_line[0]).zfill(8))
ser.write("\n")
ser.write(str(pos_line[1]).zfill(8))
ser.write("\n")
ser.write(str(pos_circle[0]).zfill(8))
ser.write("\n")
ser.write(str(pos_circle[1]).zfill(8))
ser.write("\n")
ser.write(str(round(sun_dif_angle,4)).zfill(8))
ser.write("\n")
ser.close()
